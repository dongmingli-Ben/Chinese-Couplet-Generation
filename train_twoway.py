...
from model import TwowayTransformer

batch_size = 16
path = './save/TwowayTransformer-4.742898468816423-0.9974874371859297.pt'
n_layers = 4
d_ff = 1024
head = 6
model_dim = 300
...
mdl = TwowayTransformer(path, lang, n_layers, model_dim, 
